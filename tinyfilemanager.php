...
$root_path = $global['videos_directory'];
...
if (isset($_GET['new']) && isset($_GET['type']) && !FM_READONLY) {
    fm_set_msg('File creation is disabled');
    if (false) {
        $type = $_GET['type'];
...
foreach ($folders as $f) {
    ...
    <?php endif; ?>
                                                                                                                                                                            <td class="inline-actions"><?php if (!FM_READONLY): ?>
                                                                                                                                                                                    ...
                                                                                                                                                                                    <a title="<?php echo lng('Rename') ?>" href="#" onclick="rename('<?php echo fm_enc(FM_PATH) ?>', '<?php echo fm_enc(addslashes($f)) ?>');
                                                                                                                                                            ...
                                                                                                                                                            <div class="row">
                                                                                                                                                                    ...
                                                                                                                                                                    <div class="col-xs-12 col-sm-9">
                                                                                                                                                                        <ul class="list-inline footer-action">
                                                                                                                                                                            <li class="list-inline-item"> <a href="#/select-all" class="btn btn-small btn-outline-primary btn-2" onclick="select_all();
                            return false;"><i class="fa fa-check-square"></i> <?php echo lng('SelectAll') ?> </a></li>
...
function fm_show_header() {
    ...
    ?>
                            ...
                            return false;"><i class="fa fa-check-circle"></i> <?php echo lng('CreateNow') ?></button>
                                                                                                                                                                                                            </div>
                                                                                                                                                                                                            </div>
                                                                                                                                                                                                            </div>
                                                                                                                                                                                                            </div>
...
function fm_show_footer() {
    ...
    <?php if (FM_USE_HIGHLIGHTJS): ?>
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            window.open("https://tinyfilemanager.github.io/docs/pwd.html", '_blank');
                                                                                                                                                                                                            }
                                                                                                                                                                                                            //Save Settings
    ...
    <?php if (isset($_GET['edit']) && isset($_GET['env']) && FM_EDIT_FILE): ?>
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                var $modeEl = $("select#js-ace-mode"), $themeEl = $("select#js-ace-theme"), optionNode = function (type, arr) {
                                                                                                                                                                                                                var $Option = "";
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                if (window.config && window.config.aceMode) {
                                                                                                                                                                                                                $modeEl.html(optionNode("ace/mode/", window.config.aceMode));
                                                                                                                                                                                                                }
                                                                                                                                                                                                                if (window.config && window.config.aceTheme) {
                                                                                                                                                                                                                var lightTheme = optionNode("ace/theme/", window.config.aceTheme.bright), darkTheme = optionNode("ace/theme/", window.config.aceTheme.dark);
